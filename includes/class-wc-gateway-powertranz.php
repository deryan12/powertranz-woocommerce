...
class WC_Gateway_PowerTranz extends WC_Payment_Gateway
{
    ...
    public function payment_fields()
    {
        ...
        <div class="powertranz-two-col">

            <!-- ===== FORM FIELDS (LEFT / FIRST) ===== -->
                ...
                <div class="creditcard">
                    ...
                    <div class="back">
                        ...
                        C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                ...
                                <g class="st8">
                                    <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">código de
                                        seguridad</text>
                                </g>
