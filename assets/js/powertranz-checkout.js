/**
 * PowerTranz Checkout – Formulario de Tarjeta de Crédito (basado en CodePen quinlo/YONMEa)
 * Requiere IMask 3.x cargado globalmente.
 */
(function () {
    'use strict';

    /* ── Esperar al DOM (no depende de jQuery) ── */
    function initPowerTranzForm() {
        ...
        /* ── IMASK – Código de Seguridad ── */
        var securitycode_mask = new IMask(securitycode, {
            mask: '0000'
        });

        /* ──────────────────────────────────────── */
        /* CADENAS DE ICONOS SVG (inline)            */
        /* ──────────────────────────────────────── */
        ...
        /* ── Detección de marca de tarjeta al escribir ── */
        ...
        /* ── Vista previa en vivo: Número de tarjeta ── */
        cardnumber_mask.on('accept', function () {
            ...
            /* sincronizar con campo oculto de WC (solo dígitos) */
            if (wcCardNumber) wcCardNumber.value = cardnumber_mask.unmaskedValue;
        });

        /* ── Vista previa en vivo: Vencimiento ── */
        expirationdate_mask.on('accept', function () {
            ...
            /* sincronizar con campo oculto de WC */
            if (wcCardExpiry) wcCardExpiry.value = expirationdate_mask.value;
        });

        /* ── Vista previa en vivo: Código de Seguridad ── */
        ...
        /* ── Eventos de enfoque: voltear tarjeta ── */
        ...
        /* ── Sincronizar campos ocultos antes del envío del formulario de WooCommerce ── */
    ...
    /* También ejecutar cuando WooCommerce actualiza el checkout vía AJAX */
